...
TelegramBot.unwrap = function(cb) {
    ...
    return function (err, res, body) {
        ...
        if (!err && typeof body !== 'undefined' && !body.ok) err = TelegramBot.error(body.description, body.error_code, res.statusCode);
        if (!err && res.statusCode != 200) err = TelegramBot.error('HTTP status ' + res.statusCode + ' returned.', 0, res.statusCode);
